...
<model ref="r:9dd6ea87-5a25-46d0-b7ac-5de24c4d98f1(PersonsAndFamilies.structure)">
  ...
  <node concept="1TIwiD" id="57pZU2XSTeN">
    ...
    <node concept="1TJgyj" id="4dXmJ69Gzhe" role="1TKVEi">
      <property role="IQ2ns" value="4863143166073779278" />
  ...
  <node concept="1TIwiD" id="57pZU2XSTeK">
    ...
    <node concept="1TJgyj" id="4dXmJ69Gzhg" role="1TKVEi">
      <property role="IQ2ns" value="4863143166073779280" />
      <property role="20lmBu" value="reference" />
  ...
  <node concept="PlHQZ" id="46cQNHkcdIw">
    ...
    <node concept="PrWs8" id="7qXLK8FK8bL" role="PrDN$">
      <ref role="PrY4T" to="tpck:h0TrEE$" resolve="INamedConcept" />
    </node>
  </node>
