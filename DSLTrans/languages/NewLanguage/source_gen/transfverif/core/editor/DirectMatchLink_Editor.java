...
public class DirectMatchLink_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_zh26vf_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefCell_zh26vf_e0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefCell_zh26vf_e0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("target");
    provider.setNoTargetText("<no target>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new DirectMatchLink_Editor._Inline_zh26vf_a4a());
    editorCell = provider.createEditorCell(editorContext);
    if (editorCell.getRole() == null) {
      editorCell.setReferenceCell(true);
  ...
  public static class _Inline_zh26vf_a4a extends InlineCellProvider {
    public _Inline_zh26vf_a4a() {
      super();
    }
    public EditorCell createEditorCell(EditorContext editorContext) {
      return this.createEditorCell(editorContext, this.getSNode());
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_zh26vf_a0e0(editorContext, node);
    }
    private EditorCell createProperty_zh26vf_a0e0(EditorContext editorContext, SNode node) {
      CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
      provider.setRole("ID");
      provider.setNoTargetText("<no ID>");
      provider.setReadOnly(true);
